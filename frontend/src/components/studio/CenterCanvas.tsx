...
export const CenterCanvas: React.FC = () => {
  ...
  const aspectClass =
    aspectRatio === '9:16'
      ? 'aspect-[9/16] max-w-[340px] max-h-[64vh]'
      : aspectRatio === '16:9'
      ? 'aspect-[16/9] max-w-[620px] max-h-[64vh]'
      : 'aspect-[1/1] max-w-[460px] max-h-[64vh]';
      ...
      <div className="h-13 border-b border-slate-800/80 bg-slate-950/60 px-4 flex items-center justify-between gap-4 shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-4 py-1.5 rounded-xl text-xs font-bold text-slate-950 bg-gradient-to-r from-sky-400 to-blue-500 hover:from-sky-300 hover:to-blue-400 transition flex items-center gap-1.5 shadow-lg shadow-sky-500/20 cursor-pointer"
          >
        ...
        >
          {currentProject.video_url ? (
            ...
            <div className="flex flex-col items-center justify-center p-6 text-slate-500 text-center">
              ...
              <p className="text-[11px] text-slate-600 mt-1">Upload a video or create demo project</p>
            </div>
          )}
          ...
          {!isPlaying && currentProject.video_url && (
            <button
              onClick={togglePlay}
